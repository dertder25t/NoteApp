...
export default function MainDashboard({ onFolderClick, onProfileClick }: MainDashboardProps) {
  ...
  const folders = [
    { id: "biology", name: "Biology", description: "Cell structure and functions", cards: 128, color: "bg-pink-500" },
    { id: "math", name: "Mathematics", description: "Calculus and algebra problems", cards: 95, color: "bg-blue-500" },
    {
      id: "chemistry",
      name: "Chemistry",
    ...
    { id: "physics", name: "Physics", description: "Quantum mechanics basics", cards: 142, color: "bg-green-500" },
    { id: "history", name: "History", description: "World War II timeline", cards: 89, color: "bg-orange-500" },
    { id: "literature", name: "Literature", description: "Shakespeare analysis", cards: 67, color: "bg-red-500" },
  ]
